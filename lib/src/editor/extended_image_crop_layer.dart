...
class ExtendedImageCropLayerState extends State<ExtendedImageCropLayer>
  ...
  Widget build(BuildContext context) {
    ...
    final tapRect = Rect.fromLTWH(
      cropRect!.left,
      cropRect!.top +
          ((max(cropRect!.height, cropRect!.width) -
                  min(cropRect!.height, cropRect!.width)) /
              2),
      min(cropRect!.height, cropRect!.width),
      min(cropRect!.height, cropRect!.width),
    );
    ...
    final Widget result = CustomPaint(
      ...
      child: Stack(
        children: <Widget>[
          // top left
          Positioned(
            top: tapRect.top + gWidth,
            left: tapRect.left + gWidth,
            child: SizedBox(
              height: gWidth * 2.5,
              width: gWidth * 2.5,
          ...
          Positioned(
            ...
            left: tapRect.left - gWidth,
            child: SizedBox(
              height: tapRect.height - gWidth * 2,
              width: gWidth * 2,
              child: GestureDetector(
                behavior: HitTestBehavior.translucent,
